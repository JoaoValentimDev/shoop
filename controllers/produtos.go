...
func UpdateForm(w http.ResponseWriter, r *http.Request) {
	...
	produto := models.BuscarUnicoProduto(id)
	temp.ExecuteTemplate(w, "update", produto)
}
...
func Update(w http.ResponseWriter, r *http.Request) {
	if r.Method == "POST" {
		...
		models.Update(nome, descricao, precoConvertidoParaFloat, quantidadeConvertidaParaInt, idConvertidoParaInt)
	}
	http.Redirect(w, r, "/", 301)
}
